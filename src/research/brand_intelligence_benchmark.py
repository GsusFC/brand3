...
def default_benchmark_cases() -> list[BrandIntelligenceBenchmarkCase]:
    return [
        ...
        BrandIntelligenceBenchmarkCase("ChatGPT", "https://chatgpt.com", label="chatgpt-contextdev", owned_web_provider="contextdev", exa_results=3),
        ...
        BrandIntelligenceBenchmarkCase("LangChain", "https://www.langchain.com", label="langchain-contextdev", owned_web_provider="contextdev", exa_results=3),
