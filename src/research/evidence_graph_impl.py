...
from src.research.evidence_graph_sources import (
...
def build_evidence_graph_from_snapshot(snapshot: dict[str, Any]) -> EvidenceGraph:
    ...
    claims, dedupe_stats = build_claims_from_snapshot(
        snapshot,
        sources=sources,
...
def _build_sources(snapshot: dict[str, Any], *, entity_packet: dict[str, Any] | None) -> dict[str, ResearchSource]:
    from src.research.evidence_graph_sources import build_sources

    return build_sources(snapshot, entity_packet=entity_packet)
