...
from src.visual_signature._internal.playwright_capture_dismissal_rules import contains_phrase as _contains_phrase_impl
from src.visual_signature._internal.playwright_capture_dismissal_rules import dismissal_context_type_for as _dismissal_context_type_impl
from src.visual_signature._internal.playwright_capture_dismissal_rules import dismissal_eligibility as _dismissal_eligibility_impl
from src.visual_signature._internal.playwright_capture_dismissal_rules import dismissal_patterns_for_type as _dismissal_patterns_for_type_impl
from src.visual_signature._internal.playwright_capture_dismissal_rules import dismissal_skip_note as _dismissal_skip_note_impl
from src.visual_signature._internal.playwright_capture_dismissal_rules import has_cookie_consent_signal as _has_cookie_consent_signal_impl
from src.visual_signature._internal.playwright_capture_dismissal_rules import is_concise_dismissal_label as _is_concise_dismissal_label_impl
from src.visual_signature._internal.playwright_capture_dismissal_rules import match_dismissal_pattern as _match_dismissal_pattern_impl
from src.visual_signature._internal.playwright_capture_dismissal_rules import normalize_label as _normalize_label_impl
from src.visual_signature._internal.playwright_capture_dismissal_rules import rejection_reason as _rejection_reason_impl
from src.visual_signature._internal.playwright_capture_dismissal_rules import should_attempt_obstruction_dismissal as _should_attempt_obstruction_dismissal_impl
from src.visual_signature._internal.playwright_capture_dismissal_rules import split_context_tokens as _split_context_tokens_impl
from src.visual_signature._internal.playwright_capture_dismissal_rules import COMMON_DISMISS_IGNORED_TERMS
from src.visual_signature._internal.playwright_capture_dismissal_rules import COOKIE_DISMISS_PHRASES
from src.visual_signature._internal.playwright_capture_dismissal_rules import DISMISSAL_TARGET_SELECTOR
from src.visual_signature._internal.playwright_capture_dismissal_rules import NEWSLETTER_DISMISS_PHRASES
