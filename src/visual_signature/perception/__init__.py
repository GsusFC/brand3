...
_EXPORTS = {
    ...
    "classify_mutation_result": ("src.visual_signature.perception.state_models", "classify_mutation_result"),
    "classify_obstruction_state": ("src.visual_signature.perception.state_models", "classify_obstruction_state"),
    "evaluate_intervention_eligibility": ("src.visual_signature.perception.state_models", "evaluate_intervention_eligibility"),
}
