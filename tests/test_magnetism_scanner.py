...
class MagnetismScannerTests(unittest.TestCase):
    ...
    def test_magnetism_scanner_preserves_language_on_detail_tabs(self):
        ...
        self.assertIn(f"/magnetism-scanner/scan/{scan_id}/client-tldr-v2?lang=es", detail_es.text)
        self.assertIn("TLDR v2 Preview", detail_es.text)
        self.assertIn("Preview", detail_es.text)
    ...
    def test_legacy_tldr_route_output_remains_unchanged(self):
        ...
        self.assertIn("TLDR v2 Preview", detail.text)
