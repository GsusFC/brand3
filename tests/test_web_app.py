...
class WebAppFlowTests(unittest.TestCase):
    ...
    def test_homepage_prioritizes_brand_audit_and_supported_surfaces(self):
        ...
        self.assertIn("Ejecutar escáner", response.text)
        ...
        self.assertIn("Empieza aquí. Usa el escáner para abrir un análisis; Brand Audit sigue disponible como ruta dedicada.", response.text)
    ...
    def test_homepage_preserves_ui_language_for_navigation(self):
        ...
        self.assertIn('href="/brand-audit?lang=en"', response.text)
    ...
    def test_full_flow_queued_to_ready(self):
        ...
        self.assertNotIn('class="main-nav-link" href="/"><', report_resp.text)
